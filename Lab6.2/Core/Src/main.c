...
osTimerId_t led_1Handle;
const osTimerAttr_t led_1_attributes = {
  .name = "led_1"
};
/* Definitions for led_2 */
osTimerId_t led_2Handle;
const osTimerAttr_t led_2_attributes = {
  .name = "led_2"
};
/* Definitions for led_3 */
osTimerId_t led_3Handle;
const osTimerAttr_t led_3_attributes = {
  .name = "led_3"
};
/* Definitions for led_4 */
osTimerId_t led_4Handle;
const osTimerAttr_t led_4_attributes = {
  .name = "led_4"
};
/* USER CODE BEGIN PV */
