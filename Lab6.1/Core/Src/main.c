...
/* USER CODE BEGIN Header_led_thread_1 */
/**
...
void led_thread_1(void const * argument)
{
  ...
  /* USER CODE END led_thread_1 */
}

/* USER CODE BEGIN Header_led_thread_2 */
/**
...
void led_thread_2(void const * argument)
{
  ...
  /* USER CODE END led_thread_2 */
}

/* USER CODE BEGIN Header_led_thread_3 */
/**
...
void led_thread_3(void const * argument)
{
  ...
  /* USER CODE END led_thread_3 */
}

/* USER CODE BEGIN Header_led_thread_4 */
/**
* @brief Function implementing the led_4 thread.
* @param argument: Not used
* @retval None
*/
